        ...
        return (
            <>
                ...
                <ul>
                    ...
                    <li><a target="_blank" href="http://www.oblblansko.cz/8-slider/210-lesem-polem-a-na-slunci">Článek na OBL</a>
                    </li>
                ...
                <div className="gallery">
                    <div className="col-lg-6 col-xs-12">
                        <img alt="Obrazek v galerii" className="img-responsive" src="/gallery/lesempolem_2015/1.jpg"/>
                    </div>
                    <div className="col-lg-6 col-xs-12">
                        <img alt="Obrazek v galerii" className="img-responsive" src="/gallery/lesempolem_2015/2.jpg"/>
                    </div>
                    <div className="col-lg-6 col-xs-12">
                        <img alt="Obrazek v galerii" className="img-responsive" src="/gallery/lesempolem_2015/3.jpg"/>
                    </div>
                    <div className="col-lg-6 col-xs-12">
                        <img alt="Obrazek v galerii" className="img-responsive" src="/gallery/lesempolem_2015/4.jpg"/>
                    </div>
                    <div className="col-lg-6 col-xs-12">
                        <img alt="Obrazek v galerii" className="img-responsive" src="/gallery/lesempolem_2015/5.jpg"/>
                    </div>
                </div>
            </>
        )
